...
const schema = z.object({
  ...
  ENTRY_MIN_SOL_RESERVE: z.coerce.number().min(0).default(0.05),
  ENTRY_MIN_POSITION_SOL: z.coerce.number().min(0).default(0.02),
  ENTRY_MAX_POSITION_SOL: z.coerce.number().min(0).default(0.1),
