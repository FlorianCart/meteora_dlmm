...
const schema = z.object({
  ...
  AUTO_OPEN_TARGET_POSITIONS: z.coerce.number().int().min(1).max(10).default(1),
  AUTO_TOP_UP_TARGET_POSITIONS: boolDefault(false),
  AUTO_TOP_UP_INTERVAL_MS: z.coerce.number().int().min(30_000).default(300_000),
...
export const config = {
  ...
  autoOpenTargetPositions: env.AUTO_OPEN_TARGET_POSITIONS,
  autoTopUpTargetPositions: env.AUTO_TOP_UP_TARGET_POSITIONS,
  autoTopUpIntervalMs: env.AUTO_TOP_UP_INTERVAL_MS,
